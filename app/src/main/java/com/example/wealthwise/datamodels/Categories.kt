...
object Categories{
    ...
    fun transferCategory(): ArrayList<String>{
        val listTransfer = ArrayList<String>()
        listTransfer.add("Cash to Digital")
        listTransfer.add("Digital to Cash")
        listTransfer.add("Digital to Digital")
        return listTransfer
    }
}